...
import 'package:dart_chromecast/utils/log.dart';

class CastSender extends Object {
  final Logger log = const Logger('CastSender');
...
//    _receiverStatusTick();
  ...
  void loadPlaylist(List<CastMedia> media, {bool append = false, bool forceNext = false}) {
    if (!append) {
      _contentQueue = media;
    } else {
